...
export function HeaderCartButton({ className, iconClassName }: { className?: string, iconClassName?: string }) {
  ...
  return (
    ...
    >
      <ShoppingCart className={`h-6 w-6 ${iconClassName || "text-text-main"}`} />
