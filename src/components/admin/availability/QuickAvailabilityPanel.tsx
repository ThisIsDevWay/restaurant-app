  ...
  if (!isOpen) {
    return (
      <button
        ...
        className={cn(
          "z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#251a07] text-white shadow-2xl transition-all hover:scale-110 active:scale-95 md:h-16 md:w-16",
